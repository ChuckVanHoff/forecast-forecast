...
target = os.path.join(repo, error_file)# directory, error_file)
...
alpha = 0.1
lasso = Lasso(alpha=alpha, tol=.1, max_iter=100000, normalize=True)
# Run it! Create the model from the algorithm and print some results.
print(f'Running lasso...this might take a while. Started at {time.ctime()}')
